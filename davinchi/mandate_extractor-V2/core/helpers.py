...
def display_files_and_obtain_statement_selection():
...
def display_files_and_loandisk_mandate_obtain_selection():
    
    target_folder = "mandates"
    ...
    return f'{target_folder}/{selected_file_name}'